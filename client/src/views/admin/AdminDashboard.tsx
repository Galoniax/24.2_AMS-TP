        ...
        <nav className="w-full h-full flex items-start justify-center px-3 py-8">
          <ul className="w-full h-full flex flex-col gap-5">
            <li
              ...
              style={view === 'books' ? { fontWeight: 'bold' } : {}}
            >
              <MdBook /> Gestionar libros
            </li>
            <li
              className="flex items-center gap-2 text-blue-600 cursor-pointer"
              onClick={() => changeView('users')}
              style={view === 'users' ? { fontWeight: 'bold' } : {}}
            >
              <BiUser /> Gestionar usuarios
            </li>
            <li
              className="flex items-center gap-2 text-blue-600 cursor-pointer"
              onClick={() => changeView('categories')}
              style={view === 'categories' ? { fontWeight: 'bold' } : {}}
            >
              <MdCategory /> Gestionar categorías
            </li>
